...
saved=true;
newFileFlag=true;
fileName=new String("Nikhil Notepad");
...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Nikhil ",JOptionPane.INFORMATION_MESSAGE);
}
else
...
{
new Notepad();
/*Image im = Toolkit.getDefaultToolkit().getImage("notepad (1) .png");
  	    setIconImage(im);*/
...
final String aboutText=
	...
	+"<p align=right>Developed By Nikhil!"
	+"<hr><p align=left>I Used jdk7.1 to compile the source code.<br><br>"
	+"<strong>Thank you for using this Notepad</strong><br>"
	+"Name:-1) NIkhil   Maske 2) Sachin Shingare    3) Dhanshri badole    4) Pratiksha Shambharkar <p align=center>"
	+"<hr><em><big>niks1137@gmail.com</big></em><hr><html>";
